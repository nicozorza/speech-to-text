...
from src.Estimators.ctc_self_attention.CTCSelfAttentionData import SelfAttentionData
...
network_data = SelfAttentionData()
...
network_data.self_attention_hidden_size = 128
