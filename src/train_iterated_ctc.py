...
network_data = IteratedCTCData()
network_data.model_path = project_data.ITERATED_CTC_MODEL_PATH
...
network_data.num_fw_cell_units_1 = [128]
network_data.num_bw_cell_units_1 = [128]
...
# network_data.num_cell_units = [250]
# network_data.cell_activation = [tf.nn.tanh]
network_data.num_fw_cell_units_2 = [50]
network_data.num_bw_cell_units_2 = [50]
...
network = IteratedCTC(network_data)
